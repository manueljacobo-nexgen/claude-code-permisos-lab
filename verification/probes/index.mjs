/**
 * Sondas: cada una define un fixture y los resultados esperados.
 * Las tres superficies de verificación ejecutan estas mismas sondas.
 */
...
export const probes = [
  {
    ...
    expected: {
      ...
      totals: { findings: 1, rules: 5 },
      flags: { hasSettings: true, hasConflict: false }
    }
  },
  {
    ...
    expected: {
      summary: { CRITICAL: 1, HIGH: 0, MEDIUM: 1, INFO: 1 },
      totals: { findings: 3, rules: 5 },
      flags: { hasSettings: true, hasConflict: false }
    }
  },
  {
    ...
    expected: {
      summary: { CRITICAL: 0, HIGH: 1, MEDIUM: 0, INFO: 1 },
      totals: { findings: 2, rules: 6 },
      flags: { hasSettings: true, hasConflict: false }
    }
  },
  {
    ...
    expected: {
      summary: { CRITICAL: 2, HIGH: 0, MEDIUM: 0, INFO: 1 },
      totals: { findings: 3, rules: 6 },
      flags: { hasSettings: true, hasConflict: true }
    }
  },
  {
    ...
    expected: {
      ...
      totals: { findings: 1, rules: 0 },
      flags: { hasSettings: false, hasConflict: false }
    }
  },
  {
    name: 'empty',
    ...
    expected: {
      summary: { CRITICAL: 0, HIGH: 3, MEDIUM: 1, INFO: 1 },
      totals: { findings: 5, rules: 0 },
      flags: { hasSettings: true, hasConflict: false }
    }
  },
  {
  ...
  },
  {
    ...
    expected: {
      summary: { CRITICAL: 60, HIGH: 3, MEDIUM: 1, INFO: 1 },
      totals: { findings: 65, rules: 60 },
      flags: { hasSettings: true, hasConflict: false }
    }
  }
];
